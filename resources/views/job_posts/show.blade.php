    ...
    <div class="bg-white rounded-lg shadow-lg overflow-hidden">
        ...
        <div class="bg-gradient-to-r from-purple-600 to-purple-700 px-6 py-8">
            <div class="flex flex-col md:flex-row md:items-start md:justify-between">
                <div class="flex items-start space-x-4 mb-4 md:mb-0">
                    @if($jobPost->image)
                        <img src="{{ asset('storage/' . $jobPost->image) }}" alt="{{ $jobPost->company }}" class="w-16 h-16 rounded-lg object-cover border-2 border-white">
                    @else
                        <div class="w-16 h-16 bg-white bg-opacity-20 rounded-lg flex items-center justify-center border-2 border-white">
        ...
        <div class="p-6">
                ...
                <div class="bg-purple-50 p-4 rounded-lg border border-purple-200">
                    <div class="flex items-center space-x-3">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-purple-800">{{ $jobPost->dateline?->format('M d, Y') ?? 'No deadline' }}</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="flex flex-wrap gap-2 mb-6">
                <span class="inline-flex items-center px-3 py-1 rounded-full text-sm font-medium {{ $jobPost->is_active ? 'bg-green-100 text-green-800' : 'bg-red-100 text-red-800' }}">
                ...
                <div class="bg-gray-50 p-6 rounded-lg border border-gray-200">
                    ...
                    <div class="space-y-3">
                        <div class="flex justify-between items-center">
                            ...
                            <span class="font-medium text-gray-800">{{ $jobPost->publishdate?->format('M d, Y') ?? 'Not specified' }}</span>
                        </div>
                        <div class="flex justify-between items-center">
                            <span class="text-gray-600">Application Deadline:</span>
                            <span class="font-medium {{ $jobPost->dateline && $jobPost->dateline->isPast() ? 'text-red-600' : 'text-gray-800' }}">
